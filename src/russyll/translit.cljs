...
(defn last-palat [word]
  (-- word (re-pattern "[лмнрцкгзвпджчшстбфщ][ъь]$") #(.toUpperCase (first %))))

(defn ^:export translit [word]
  (reduce #(%2 %1) word [last-palat j-extract palat-extract]))


;;;;;;;;;;;; This file autogenerated from src/cljx/translit.cljx
